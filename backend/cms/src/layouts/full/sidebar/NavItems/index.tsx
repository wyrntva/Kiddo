    ...
    <>
      <Sidebar.Item
        ...
        className={`${item.url == pathname
          ? "text-white bg-[#FEA01F] rounded-[16px] hover:text-white hover:bg-[#E68A10] dark:hover:text-white shadow-btnshdw active !pl-5"
              ...
              item.icon ? (
                ...
                <span
                  className={`${item.url == pathname
                    ...
                    : "h-[6px] w-[6px] bg-black/40 dark:bg-white rounded-full mx-1.5 group-hover/link:bg-[#FEA01F] mr-6 shrink-0"
                    } `}
                ></span>
              )
            )}
