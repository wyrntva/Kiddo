...
const imgLogo1  = "/assets/logo_ottopia.png"
...
const NAV_ITEMS: { page: Page; label: string; icon: React.ReactNode }[] = [
  ...
  {
    page: 'achievements', label: 'Thành tích',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
  ...
  {
    page: 'playground', label: 'Sân chơi',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
        <path d="M8.00014 7.25C8.41435 7.25 8.75014 7.58579 8.75014 8V9.25H10.0001C10.4144 9.25 10.7501 9.58579 10.7501 10C10.7501 10.4142 10.4144 10.75 10.0001 10.75H8.75014V12C8.75014 12.4142 8.41435 12.75 8.00014 12.75C7.58592 12.75 7.25014 12.4142 7.25014 12V10.75H6.00014C5.58592 10.75 5.25014 10.4142 5.25014 10C5.25014 9.58579 5.58592 9.25 6.00014 9.25H7.25014V8C7.25014 7.58579 7.58592 7.25 8.00014 7.25Z" fill="currentColor"/>
        <path d="M17.0001 11.75C17.0001 11.1977 16.5524 10.75 16.0001 10.75C15.4479 10.75 15.0001 11.1977 15.0001 11.75V12C15.0001 12.5523 15.4479 13 16.0001 13C16.5524 13 17.0001 12.5523 17.0001 12V11.75Z" fill="currentColor"/>
        <path d="M16.0001 7C16.5524 7 17.0001 7.44772 17.0001 8V8.25C17.0001 8.80228 16.5524 9.25 16.0001 9.25C15.4479 9.25 15.0001 8.80228 15.0001 8.25V8C15.0001 7.44772 15.4479 7 16.0001 7Z" fill="currentColor"/>
        <path d="M19.0001 10C19.0001 10.5523 18.5524 11 18.0001 11H17.7501C17.1979 11 16.7501 10.5523 16.7501 10C16.7501 9.44771 17.1979 9 17.7501 9H18.0001C18.5524 9 19.0001 9.44772 19.0001 10Z" fill="currentColor"/>
        <path d="M14.2501 11C14.8024 11 15.2501 10.5523 15.2501 10C15.2501 9.44772 14.8024 9 14.2501 9H14.0001C13.4479 9 13.0001 9.44771 13.0001 10C13.0001 10.5523 13.4479 11 14.0001 11H14.2501Z" fill="currentColor"/>
        <path fillRule="evenodd" clipRule="evenodd" d="M12.7501 3C12.7501 2.58579 12.4144 2.25 12.0001 2.25C11.5859 2.25 11.2501 2.58579 11.2501 3V4.48688C9.81103 4.50654 8.37251 4.58282 6.93791 4.71571L6.60631 4.74642C4.21461 4.96797 2.37293 6.95407 2.33222 9.35566L2.32013 10.0691C2.27283 12.8602 2.49781 15.6492 2.99188 18.3967C3.23684 19.7588 4.42218 20.75 5.80618 20.75H6.02723C7.26259 20.75 8.3819 20.022 8.88276 18.8927L9.94336 16.5014C10.7345 14.7177 13.2658 14.7177 14.0569 16.5014L15.1175 18.8927C15.6184 20.022 16.7377 20.75 17.973 20.75H18.1941C19.5781 20.75 20.7634 19.7588 21.0084 18.3967C21.5025 15.6492 21.7275 12.8602 21.6801 10.0691L21.6681 9.35566C21.6274 6.95406 19.7857 4.96797 17.394 4.74643L17.0624 4.71571C15.6278 4.58282 14.1892 4.50654 12.7501 4.48688V3Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
