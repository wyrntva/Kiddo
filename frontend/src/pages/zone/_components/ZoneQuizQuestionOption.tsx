...
export default function ZoneQuizQuestionOption({
  ...
  return (
    ...
    >
      ...
      <div className="zone-question-image relative flex aspect-[4/3] sm:aspect-square w-full items-center justify-center overflow-hidden rounded-[12px] border border-gray-100 bg-gray-50 sm:rounded-2xl">
        {hasCustomStyle ? (
