...
export default function ZoneEncouragementCard({ theme }: { theme: ZoneTheme }) {
  return (
    <div
      className="kiddo-zone-card relative flex h-full w-full items-center overflow-clip rounded-[16px] transition-all duration-300 ease-out hover:-translate-y-1.5"
      style={{
    ...
    >
      <div className="z-10 flex w-[54%] shrink-0 flex-col items-start justify-center self-stretch p-4 text-left sm:w-[48%] min-[1800px]:w-[279px] min-[1800px]:p-6">
