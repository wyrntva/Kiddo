      ...
      <main className="flex-1 min-h-[calc(100vh-64px)] relative flex items-center justify-center py-[48px] px-4 md:px-[48px] overflow-hidden">
        ...
        {showGame ? (
          ...
          <div className="relative z-10 w-full max-w-[1200px] mx-auto flex flex-col gap-8 md:gap-[48px] items-center justify-center min-h-[600px] py-8">
            ...
            {/* Mascot floating on the grassy slope shifted 500px to the left, scaled up by 30% */}
            <div className="absolute left-[-100px] sm:left-[-180px] md:left-[-320px] lg:left-[-280px] bottom-[60px] sm:bottom-[100px] md:bottom-[130px] lg:bottom-[160px] w-[160px] sm:w-[210px] md:w-[260px] lg:w-[310px] pointer-events-none z-10">
              <img
                src={imgMascot}
                alt="Mascot"
