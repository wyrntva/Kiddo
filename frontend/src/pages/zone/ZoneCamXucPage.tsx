...
const imgZone         = "/assets/vung_dat_cam_xuc_island.png"
...
const lessons: Lesson[] = [
  { id: 1, title: 'Niềm vui của con', description: "- Trẻ nhận biết cảm xúc vui của bản thân.\n- Trẻ biết cách chia sẻ niềm vui với người khác.", status: 'completed',    stars: 5 },
  { id: 2, title: 'Nỗi buồn bé nhỏ', description: "- Biết rằng buồn không phải là điều xấu và có thể nói ra nỗi buồn để được lắng nghe, an ủi", status: 'in-progress',  stars: 0 },
  { id: 3, title: 'Cơn giận đang tới', description: "- Trẻ nhận biết cảm xúc tức giận và biết lựa chọn cách bình tĩnh phù hợp.", status: 'not-started',  stars: 0 },
  { id: 4, title: 'Khi con thấy sợ', description: "- Trẻ nhận biết cảm xúc sợ hãi và biết tìm kiếm sự giúp đỡ khi cần.", status: 'not-started',  stars: 0 },
  { id: 5, title: 'Nói ra cảm xúc của mình', description: "- Trẻ nhận biết cảm xúc sợ hãi và biết tìm kiếm sự giúp đỡ khi cần.", status: 'not-started',  stars: 0 },
]
  ...
  return (
    ...
    >
      ...
      <div className="flex sm:flex-[1_0_0] h-[120px] sm:h-auto gap-3 items-end justify-end min-w-px relative self-stretch">
        ...
        <div
          className="absolute bg-[#339e4a] border-2 border-white hover:scale-105 hover:brightness-110 active:scale-95 transition-all duration-200 ease-out flex items-center justify-center rounded-full w-10 h-10 shrink-0"
          style={{ left: -7, top: -9 }}
        >
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto px-4 md:px-[48px] pt-[48px] pb-[48px] flex flex-col gap-[48px]">
          ...
          <div className="flex flex-col xl:flex-row gap-[16px] items-center justify-between w-full">
            ...
            <div className="flex-1 flex flex-col gap-[4px] items-center justify-center text-center">
              <p className="font-baloo text-[44px] md:text-[60px] font-bold leading-[56px] md:leading-[90px] text-[#339E4A] whitespace-nowrap">
                Vùng đất cảm xúc
              </p>
            ...
            <div className="w-full xl:w-[350px] flex justify-center xl:justify-end shrink-0">
              <div className="bg-white border border-[#c3ffd0] shadow-[0px_0px_10px_rgba(51,158,74,0.2)] hover:shadow-[0px_6px_15px_rgba(51,158,74,0.4)] hover:-translate-y-0.5 transition-all duration-300 ease-out flex flex-col gap-3 items-start p-4 rounded-[24px] w-full xl:w-[350px]">
                {/* Header row */}
                <div className="flex gap-3 items-center w-full">
                  ...
                  <div className="flex gap-2 items-center shrink-0">
                     <span className="font-baloo text-[24px] font-bold leading-[40px] text-[#418457]">{COMPLETED}/{TOTAL}</span>
