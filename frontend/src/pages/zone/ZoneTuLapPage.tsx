...
const imgHeroBg       = "/assets/414120eafd7f43fce93ce3ecb953fc4142aa8c32.png"
const imgZone         = "/assets/ngoi_lang_tu_lap_island.png"
  ...
  return (
    <div className="bg-white border border-[#fff4bf] shadow-[0px_0px_10px_rgba(254,160,31,0.4)] hover:shadow-[0px_8px_20px_rgba(254,160,31,0.6)] hover:-translate-y-1.5 active:scale-[0.99] transition-all duration-300 ease-out cursor-pointer flex flex-col sm:flex-row items-start gap-6 p-6 rounded-[16px] w-full h-full kiddo-zone-card" style={{ minHeight: '224px' }}>
      ...
      <div className="flex sm:flex-[1_0_0] h-[120px] sm:h-auto gap-3 items-end justify-end min-w-px relative self-stretch">
        ...
        <div
          className="absolute bg-[#fea01f] border-2 border-white hover:scale-105 hover:brightness-110 active:scale-95 transition-all duration-200 ease-out flex items-center justify-center rounded-full w-10 h-10 shrink-0"
          style={{ left: -7, top: -9 }}
        >
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto px-4 md:px-[48px] pt-[48px] pb-[48px] flex flex-col gap-[48px]">
          ...
          <div className="flex flex-col xl:flex-row gap-[16px] items-center justify-between w-full">
            ...
            <div className="flex-1 flex flex-col gap-[4px] items-center justify-center text-center">
              <p className="font-baloo text-[44px] md:text-[60px] font-bold leading-[56px] md:leading-[90px] text-[#895026] whitespace-nowrap">
                Ngôi làng tự lập
              </p>
              <div className="flex flex-wrap gap-[6px] justify-center items-center shrink-0">
                ...
                <p className="font-vietnam font-bold text-[16px] md:text-[22px] leading-[24px] md:leading-[28px] text-[#37393E]">
                  Cùng Toro học cách tự lập và tự chăm sóc bản thân nhé!
                </p>
                <div className="w-6 h-6 md:w-7 md:h-7 shrink-0">
                  <HeartIcon color="#895026" />
                </div>
              </div>
            </div>
            ...
            <div className="w-full xl:w-[350px] flex justify-center xl:justify-end shrink-0">
              <div className="bg-white border border-[#ffe7bf] shadow-[0px_0px_10px_rgba(254,160,31,0.2)] hover:shadow-[0px_6px_15px_rgba(254,160,31,0.4)] hover:-translate-y-0.5 transition-all duration-300 ease-out flex flex-col gap-3 items-start p-4 rounded-[24px] w-full xl:w-[350px]">
                {/* Header row */}
                <div className="flex gap-3 items-center w-full">
                  ...
                  <div className="flex gap-2 items-center shrink-0">
                     <span className="font-baloo text-[24px] font-bold leading-[40px] text-[#fea01f]">{COMPLETED}/{TOTAL}</span>
