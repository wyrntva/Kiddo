...
function parsePrivacy() {
  const lines = privacyContent.split(/\r?\n/).map((line) => line.trim()).filter(Boolean)
...
export default function PrivacyPage() {
  return (
    <div className="flex min-h-screen flex-col bg-[#f8faff]">
      <SEO
        title="Chính sách bảo mật - OTTOPIA"
        description="Chính sách bảo mật thông tin cá nhân và bảo vệ dữ liệu trẻ em trên nền tảng giáo dục tương tác OTTOPIA."
      />
      <Navbar />
