              ...
              <div className="p-4 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {Array.from({ length: 5 }).map((_, index) => (
                    <svg key={index} width="14" height="14" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={index < item.stars ? 'fill-[#fea01f] stroke-[#fea01f]' : 'fill-gray-200 stroke-gray-200'}>
