...
export default function SkillZoneDesktopCard({ island, className = '' }: { island: SkillZoneIsland; className?: string }) {
  return (
    <div className={`flex-1 min-w-0 flex flex-col h-[180px] md:h-[158px] lg:h-[210px] xl:h-[289px] items-center relative group ${className}`}>
      <div className="aspect-[2254/2254] overflow-clip relative w-full shrink-0 select-none pointer-events-none transition-transform duration-300 group-hover:scale-[1.03] filter drop-shadow-md">
        <div className="-translate-x-1/2 absolute left-1/2 top-0 overflow-hidden w-full max-w-[160px] md:max-w-[136px] lg:max-w-[190px] xl:max-w-[280px] aspect-square">
          <img
      ...
      <div className={`absolute bottom-0 h-[96px] md:h-[96px] lg:h-[116px] xl:h-[142px] ${island.leftOffset} -translate-x-[50%] ${island.width} z-20 scale-[0.72] md:scale-[0.64] lg:scale-[0.82] xl:scale-100 origin-bottom`}>
