const benefits = [
  {
    ...
    img: '/assets/10ff2dcd9dd7f3fb6b07b0871c783aa4b6565f61.png',
    left: 'left-[-84.55%]',
    top: 'top-[-20.66%]',
    width: 'w-[270.22%]',
    height: 'h-[152%]'
  },
  {
    ...
    img: '/assets/35280bcc80ef69d5939af8f018da49f79b362526.png',
    left: 'left-[-103.94%]',
    top: 'top-[-37.11%]',
    width: 'w-[309.09%]',
    height: 'h-[173.86%]'
  },
  {
    ...
    img: '/assets/bda3e111c571fbddd7774f85c455d5ff0c74066d.png',
    left: 'left-[-108.47%]',
    top: 'top-[-39.08%]',
    width: 'w-[317.38%]',
    height: 'h-[178.52%]'
  },
  {
    ...
    img: '/assets/b479d984a09205c9400fcd221e710df5c9fe9618.png',
    left: 'left-[-107.33%]',
    top: 'top-[-33%]',
    width: 'w-[314.67%]',
    height: 'h-[177%]'
  },
  {
    ...
    img: '/assets/aab2bcb3c53191c384468ab579ce4496875b214f.png',
    left: 'left-[-84.63%]',
    top: 'top-[-25.76%]',
    width: 'w-[268.44%]',
    height: 'h-[151%]'
...
export default function BenefitsSection() {
  return (
    <section className="w-full">
      <div className="bg-[#fef9ed] rounded-[24px] p-[24px] flex flex-col gap-[24px] items-start border border-[#fff4bf]/60 shadow-sm" data-node-id="21:697">
        
        {/* Header with stars */}
        <div className="flex items-center justify-center gap-[16px] w-full shrink-0" data-node-id="21:698">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-4 w-full" data-node-id="21:704">
          {benefits.map((b, idx) => (
            <div
              key={idx}
